...
Following the setting previously established in part I for doubly radial odd functions, we show existence, asymptotic behavior and uniqueness of saddle-shaped solutions. To accomplish this, we prove, among others, some symmetry results for more general semilinear equations, as well as maximum principles in ``narrow'' domains.

Furthermore, we also study one-dimensional solutions to $L_K u = f(u)$ in $\R^{n}$, by relating this equation with an analogous one in $\R$, with a different but related operator.
\end{abstract}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
