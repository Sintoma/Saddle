...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
This paper, which is the follow-up to part I, concerns saddle-shaped solutions to the semilinear equation $L_K u = f(u)$ in $\R^{2m}$, where $L_K$ is a linear integro-differential operator which is uniformly elliptic and with a radially symmetric kernel, and $f$ is of Allen-Cahn type. Saddle-shaped solutions are doubly radial, odd with respect to the Simons cone $\{(x', x'') \in \R^m \times \R^m \, : \, |x'| = |x''|\}$, and vanish only in this set.

Following the setting previously established in part I for doubly radial odd functions, we show existence, asymptotic behavior and uniqueness of saddle-shaped solutions. To accomplish this, we prove, among others, some symmetry results for general semilinear equations and maximum principles in narrow domains.

Furthermore, we also study one-dimensional solutions to $L_K u = f(u)$ in $\R^{n}$, by relating this equation with a similar one with a different but related operator in $\R$.
\end{abstract}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\include{Symmetry_results}

\include{Asymptotic}

\include{Maximum_principle}
