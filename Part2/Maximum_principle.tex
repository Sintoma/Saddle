...
\begin{proposition}
	...
	Let $\Omega \subset \ocal$ be an open set (not necessarily bounded) and let $L_K  \in \lcal_\star$. Let $v\in C^\alpha_(\Omega)\cap L^\infty(\R^{2m})$, for some $\alpha > 2\gamma$, be a doubly radial function satisfying
	$$
	\beqc{\PDEsystem}
...
\begin{proposition}
	...
	Let $L_K  \in \lcal_\star$ and let $v\in C^\alpha_(\Omega)\cap L^\infty(\R^{2m})$, for some $\alpha > 2\gamma$, be a doubly radial function satisfying
	\begin{equation}
...
\begin{proof}[Proof of point (ii) of Lemma~\ref{Lemma:SecondDerivativeLayer}]
	...
	arriving at a contradiction. Here we have used that $v\not \equiv 0$ and the fact that $K_1$ is decreasing in $(,+\infty)$, which yields $K_1(x - y) \geq  K_1(x + y)$ for every $x>0$ and $y>0$.
\end{proof}
