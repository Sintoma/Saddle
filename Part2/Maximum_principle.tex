...
\begin{proposition}
	...
	Let $\Omega \subset \ocal$ be an open set (not necessarily bounded) and let $L_K  \in \lcal_\star(2m,  \s)$. Let $v\in C^\alpha(\Omega)\cap L^\infty(\R^{2m})$, for some $\alpha > 2\gamma$, be a doubly radial function satisfying
	$$
	\beqc{\PDEsystem}
...
\begin{proposition}
	...
	Let $L_K  \in \lcal_\star(2m,  \s)$ and let $v\in C^\alpha(\Omega)\cap L^\infty(\R^{2m})$, for some $\alpha > 2\gamma$, be a doubly radial function satisfying
	\begin{equation}
