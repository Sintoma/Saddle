...
\begin{proposition}
	...
	Let $L_K $ and $L_{K_1}$ be two symmetric and translation invariant integral operators with kernels $K$ and $K_1$ in dimensions $n$ and $1$ respectively. 
...
\begin{equation}
	...
	|u_0 (x)| \leq C |x|^{-2\s}  \quad \text{ and } \quad |\dot{u_0} (x)| \leq C |x|^{-1-2\s}  \quad \text{ for large }|x|.
\end{equation}
