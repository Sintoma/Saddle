...
Following the setting previously established in part I for doubly radial odd functions, we show existence, asymptotic behavior, and uniqueness of the saddle-shaped solution. For this, we prove, among others, a Liouville type result, the one-dimensional symmetry of positive solutions to semilinear problems in a half-space, and maximum principles in ``narrow'' sets. To describe precisely the asymptotic behavior of the saddle-shaped solution we also need to study one-dimensional solutions to $L_K u = f(u)$ in $\R^{n}$, that we do by relating this equation with an analogous one in $\R$, for a related operator.
\end{abstract}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
