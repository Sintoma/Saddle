...
\begin{itemize}
\item Case $m=0$:
On the one hand, by interior estimates \todo{Boundary??} for $L$, $u$ is globally $C^\s$-H\"older continuous. Thus, there exists $\eta_0$ small such that, for every  $t\in(\tau-\eta_0,\tau)$,
$$ 
