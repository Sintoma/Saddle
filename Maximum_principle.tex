...
\begin{proof}
	...
	\end{equation} 
	Now, we compute $L v(x_0)$. Then, since $v$ is doubly radial and odd with respect to the Simons cone, by Lemma~\ref{Lemma:PropertiesStar}\todo{Escrbir en este lema la otra expresion} we can write
	\begin{align*}
...
\begin{proof}[Proof of Proposition~\ref{Prop:MaximumPrincipleInO}]
	...
	$$
	for some $\delta >0$. \todo{Ponerlo en una remark en la seccion de assymptotic} Moreover, by \eqref{Eq:PropertyConcavityf} we get
	\begin{equation}
