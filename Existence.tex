...
\todo[inline]{compactness argument}
...
\subsection{Alternative proof of Theorem~\ref{Th:Existence}}
...
\begin{proposition}
	...
	Let $\usub \leq \usup$ be two bounded functions that are doubly radial and odd with respect to the Simons cone. Let $L$ be an operator ... \todo{Poner las condiciones mínimas} and assume that
	$$
	\beqc{\PDEsystem}
