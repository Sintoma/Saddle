...
\end{equation}
and we extend it to $\ical$ by considering its odd reflection. It is clear that $\Psi_S$ is a bounded function with $||\Psi_S||_{L^\infty(\R^{2m})}=1$. In our arguments we will also use the following function and set:
