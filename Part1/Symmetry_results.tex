...
\begin{theorem}
	...
	$$ \todo{Es mejor ponerlo como que K es decreciente en la dirección $x_n$?}
...
proof is analogous as the one for \eqref{Eq:P1}, we include it here for completeness and further
reference.
...
0$ that solves $ L\varphi = 0 $ in $\R^n$. By Liouville Theorem, $\varphi$ must be constant, and
...
and Palatucci in \cite{DiCastoKuusiPalatucci}, given any $R>0$ we have \todo[inline,
color=red]{MIRAR LO DE MATTEO!!!!}
\begin{equation}
\label{Eq:Harnack}
