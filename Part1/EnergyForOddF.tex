...
$$
Now we split $\Omega$ into $\Omega \cap \ocal$ and $\Omega \setminus \ocal$. By using the change of variables given by $(\cdot)^\star$ and the odd symmetry of $w$, we get	\todo{Igual poner un paso mas?}
\begin{align*}
...
\begin{proof}
	Let $\eta \in C^\infty_0(\Omega)$. We define 
	$$
