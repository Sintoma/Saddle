...
\begin{proof}[Proof of Theorem~\ref{Th:EnergyEstimate}]
	...
	\end{equation}
	for every $x\in (B_S\setminus \Omega_S)\cap \ocal$ and $y \in B_{S+1}\cap \ocal$. Recall that $d_S$ is defined as $d_S(x)=\min \{S+1-|x| , \mu \dist (x, \ccal)\}$, and therefore it suffices to show that
	$$
